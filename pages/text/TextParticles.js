...
// make sure that you are using your own letter indicies
  ...
  function TextParticles( params ){ 
    ...
    this.pathToTexture  = params.pathToTexture  || "ubuntuMono.png";
    ...
    this.texture = THREE.ImageUtils.loadTexture("ubuntuMono.png") ;
  ...
  TextParticles.prototype.createLookupTexture = function( particles ){
    ...
    for( var i = 0; i < size*size; i++ ){
      ...
      if( particles[i] ){
        ...
        data[ i * 4 + 0 ] = particles[i][1] * this.letterWidth * 1.1;
